...
namespace Stock.Worker.Infrastructure.Messaging;

/// <summary>
/// Initializes RabbitMQ topology for the Stock service.
/// </summary>
public sealed class StockTopologyInitializer : ITopologyInitializer
{
    private readonly IRabbitMqConnectionFactory _connectionFactory;

    /// <summary>
    /// Initializes a new instance of the <see cref="StockTopologyInitializer"/> class.
    /// </summary>
    /// <param name="connectionFactory">The connection factory.</param>
    public StockTopologyInitializer(IRabbitMqConnectionFactory connectionFactory)
    {
        _connectionFactory = connectionFactory;
    }

    /// <summary>
    /// Declares exchanges, queues, and bindings for the Stock service.
    /// </summary>
    public void Initialize()
    {
        ...
        DeclareQueues(channel, TopologyConstants.StockQueues.OrderEventsQueue);

        channel.QueueBind(
            TopologyConstants.StockQueues.OrderEventsQueue,
            TopologyConstants.EventsExchangeName,
            TopologyConstants.EventRoutingKeys.OrderCreated);
    }
